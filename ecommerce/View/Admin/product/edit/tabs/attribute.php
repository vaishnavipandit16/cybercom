...
<div class="main">
    ...
    <form id="form" method="post" action="<?php echo $this->getUrl()->getUrl('save','Product\Attribute'); ?>">
        <?php if ($attribute):
        ...
        <div class="form-row">
            <div class="col">
                ...
                <input type="<?php echo $value->inputType; ?>" name="<?php echo $value->code; ?>"
                    value="<?php echo $option->name; ?>" <?php if ($attributeData->{$value->name} == $option->name) : ?>
                    checked <?php endif; ?>>
                <label></label>
                <?php endforeach; ?>
                <?php endif; ?>
